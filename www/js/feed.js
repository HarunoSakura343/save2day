...
function storeFeed(Feedlink, Feednaam, $networkStatus) {

    if($networkStatus != 'WiFi connection'){
        navigator.notification.alert("u got rekt m8, enable ur mofo wifi"(), function () {
